2020 Citizen Voting Age Population (CVAP) Data for Mississippi from the 2016-2020 American Community Survey (ACS) 5 Year Estimates at the Block Group level (shapefile)
...
##Processing
CVAP data for Mississippi was retrieved with a Python script from the Census. 
The data is available nationally for the Block Group. 
To extract the data for Mississippi the national data was grouped by state and then extracted to a new file for each state. 
